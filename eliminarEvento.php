 <?php
    ...
    $sql = "select * from eventosrats where idevento=$id";
    ...
    if($_POST){
        eliminarEvento($bd,'eventosrats',$_POST);
    ...
    <div class="container-fluid m-0 p-0">
        ...
        <section class=" col-6 offset-3">
            ...
            <form action="" method="POST">
                ...
                <input type="text" class="form-control" name="id" value="<?= $evento['idevento'];?>" readonly>
                <label for="nombreProducto">Nombre del producto</label>
                <input type="text" class="form-control" name="nombre" value="<?= $evento['nombreevento'];?>">
                <label for="categoriaProducto">Categoria del producto</label>
                <input type="text" class="form-control" name="apellido" value="<?= $evento['imgevento'];?>">
