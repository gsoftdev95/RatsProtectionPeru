<section class="footerInner">
    ...
    <section id="logof">
        <div class="iconosfooter">
            ...
            <a href="https://wa.me/+51925850399" target="_blank"><div><span class="icon-whatsapp"></span></div></a>                
        </div>
        <a href="./index.php"><div class="imagenfooter"></div></a>
    </section>

    <div class="footer-legal">
        <p>© <span id="currentYear"></span> RATS PROTECTION E.I.R.L. Todos los derechos reservados.</p>    
    </div>
</section>